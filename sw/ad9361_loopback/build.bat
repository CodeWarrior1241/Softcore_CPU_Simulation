@echo off
REM ================================================================================
REM NEORV32 AD9361 Loopback Test - Windows Build Script
REM ================================================================================
REM This batch file compiles the AD9361 loopback test application for NEORV32 on
REM Windows without requiring Unix-compatible make tools.
REM ================================================================================
...
set CC_FLAGS=%CC_FLAGS% -Wl,--defsym,__neorv32_rom_size=32k
...
:help
echo NEORV32 AD9361 Loopback Test Windows Build Script
echo.
...
REM Clean up -p directory created by make on Windows (mkdir -p misinterpretation)
...
:build
echo ==========================================
echo NEORV32 AD9361 Loopback Test Build
echo ==========================================
