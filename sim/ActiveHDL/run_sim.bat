@echo off
REM ================================================================================
REM NEORV32 - Aldec Active-HDL Simulation Launcher (Windows)
REM ================================================================================
REM This batch file launches Active-HDL simulation for the NEORV32 processor
REM ================================================================================

setlocal enabledelayedexpansion

REM Configuration
set VSIM="C:\Aldec\Active-HDL_15_SE\bin\vsim.exe"
set SIM_MODE=gui
set SIM_TIME=150ms
...
REM Check if Active-HDL is available
if not exist %VSIM% (
    echo ERROR: Aldec Active-HDL not found at %VSIM%
    echo Please update VSIM path in this script or install Active-HDL
    exit /b 1
)
